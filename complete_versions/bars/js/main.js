...
(function(){
    ...
    var chart, svg, height, width, chartDimens, maxCount = 0;
    ...
    var HOUSE_COLORS = {'gryffindor': ['#4C0407','#F2BE34'], 'slytherin': ['#24581E','#9E9996'],
    ...
    main.draw = function() {
        ...
        bars.transition().duration(500).ease('slow-out')
            .attr('transform', function(d){
                console.log('translate('+xScale(d.classname)+',0)');
                return 'translate('+xScale(d.classname)+',0)';});

        barsEnter.append('rect')
            .attr('width', barWidth)
            .attr('x', -barWidth/2)
            .attr('fill', function(d){return BOOK_COLORS[d.classname];});
        ...
        bars.selectAll('rect').attr('y', function(d){return  yScale(d.count);})
            .transition().duration(500).ease('slow-out')
            .attr('height', function(d){return height/2 - yScale(d.count);});
